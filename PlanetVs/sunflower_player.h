...
extern Atlas altas_sunflower_run_left;
extern Atlas altas_sunflower_run_right;
extern Atlas altas_sunflower_attack_ex_left;
extern Atlas altas_sunflower_attack_ex_right;
extern Atlas atlas_sun_text;
extern Atlas altas_sunflower_die_left;
extern Atlas altas_sunflower_die_right;
extern Player* player_1;
extern Player* player_2;
class SunflowerPlayer  : public Player {
public:
	SunflowerPlayer(bool facing_right = true) : Player(facing_right){
		animation_idle_left.set_atlas(&altas_sunflower_idle_left);
		animation_idle_right.set_atlas(&altas_sunflower_idle_right);
		animation_run_left.set_atlas(&altas_sunflower_run_left);
		animation_run_right.set_atlas(&altas_sunflower_run_right);
		animation_attack_ex_left.set_atlas(&altas_sunflower_attack_ex_left);
		animation_attack_ex_right.set_atlas(&altas_sunflower_attack_ex_right);
		animation_sun_text.set_atlas(&atlas_sun_text);
		animation_die_left.set_atlas(&altas_sunflower_die_left);
		animation_die_right.set_atlas(&altas_sunflower_die_right);
